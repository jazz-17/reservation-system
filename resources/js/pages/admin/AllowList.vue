...
const page = usePage<{ flash?: { import_report?: ImportReport | null } }>();
    ...
    <div class="flex flex-col gap-4 p-4">
        ...
        <AdminSection>
            ...
            <p class="mt-1 text-sm text-muted-foreground">
                Sube un archivo CSV/XLSX con las columnas:
                <strong>email</strong>, <strong>school_code</strong> y
                <strong>base</strong> (ej. B22 o 2022). También funciona sin
                encabezados si el orden es: email, school_code, base.
            </p>
